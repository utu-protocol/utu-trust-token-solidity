/**
 * @title TestUpgradedEndorsement Interface
 * This interface defines the public functions and events that are used for making endorsements. Note that if an
 * TestUpgradedEndorsement contract is proxied to other blockchains to provide the endorse function there, different events might be
 * emitted on the main and on the proxy contract.
 */
interface TestUpgradedEndorsementInterface {
    /**
     ...
     *         or after being forwarded to the main TestUpgradedUTT contract if called on a proxy.
