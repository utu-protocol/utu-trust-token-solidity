...
abstract contract TestUpgradedSocialConnector is ERC20Upgradeable, TestUpgradedRoles {
    /**
     ...
     *      them for it with a configured amount of TestUpgradedUTT. It's callable only by owner to prevent calls for which the
    ...
    /**
     * Sets the amount of TestUpgradedUTT to be rewarded for (new) social media connections
     * @param amount of TestUpgradedUTT to be rewarded for (new) social media connections
     */
     ...
     */
    uint256 newTestUpgradedSocialConnectorVar;
    uint256[48] private __gap;

    function incrementnewTestUpgradedSocialConnectorVar() public {
        newTestUpgradedSocialConnectorVar += 1;
    }

    function getnewTestUpgradedSocialConnectorVar() public view returns (uint256) {
        return newTestUpgradedSocialConnectorVar;
    }
}
