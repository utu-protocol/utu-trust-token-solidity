...
/**
 * @title An upgradable version of the TestUpgradedChainlinkClient contract
 * @notice Contract writers can inherit this contract in order to create requests for the
 * Chainlink network
 */
abstract contract TestUpgradedChainlinkClient is Initializable {
    ...
    function __ChainlinkClient_init_unchained() internal onlyInitializing {
        s_requestCount = 1;
    }
     ...
     */
    uint256 newTestUpgradedChainlinkClientVar;
    uint256[48] private __gap;

    function incrementnewTestUpgradedChainlinkClientVar() public {
        newTestUpgradedChainlinkClientVar += 1;
    }

    function getnewTestUpgradedChainlinkClientVar() public view returns (uint256) {
        return newTestUpgradedChainlinkClientVar;
    }
}
