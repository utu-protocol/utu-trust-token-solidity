...
contract TestUpgradedMigratable is TestUpgradedRoles {
     ...
     */
    uint256 newTestUpgradedMigratableVar;
    uint256[48] private __gap;

    function incrementnewTestUpgradedMigratableVar() public {
        newTestUpgradedMigratableVar += 1;
    }

    function getnewTestUpgradedMigratableVar() public view returns (uint256) {
        return newTestUpgradedMigratableVar;
    }
}
